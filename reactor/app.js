...
io.sockets.on('connection', function (socket) {
  ...
  socket.on('map', function(data) {
    ...
    var query = client.query( "SELECT * FROM shapes WHERE (shape_pt_lat BETWEEN $1 AND $2) AND (shape_pt_lon BETWEEN $3 AND $4) ORDER BY shape_id, shape_pt_sequence", [bb,tt,ll,rr] );
